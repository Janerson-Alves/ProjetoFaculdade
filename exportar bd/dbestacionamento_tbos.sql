...
CREATE TABLE `tbos` (
  ...
  PRIMARY KEY (`os`),
  KEY `idcli` (`idcli`),
  CONSTRAINT `tbos_ibfk_1` FOREIGN KEY (`idcli`) REFERENCES `clientes` (`idcli`)
...
INSERT INTO `tbos` VALUES (2,'2022-03-09 01:31:17','Chevrolet Onix','EXT-1234','Estacionamento','Janerson',24.50,1),(3,'2022-03-26 02:22:54','Ford Ka 2011 1.0 Manual','ABC-1234','Vaga para estacionar, lavagem de carro e polimento ','Admin',50.00,1),(4,'2022-03-26 03:33:57','Ford Ka ','acb 123','estacionamento e limpeza de carro','Jaan',50.00,9),(5,'2022-03-26 03:51:38','ford ka ','abc 1234','estacionamento e lava rapido','jaan',30.00,1);
